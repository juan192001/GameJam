...
public class Enemigos : MonoBehaviour
{
    ...
    public Sprite venusHit;
    public Sprite venusNormal;
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        if (collision.collider.CompareTag("Bullet"))
        {
            ...
            this.gameObject.GetComponent<SpriteRenderer>().sprite= venusHit;
    ...
    private IEnumerator ResumeEnemy()
    {
        ...
        isShootingPaused = false;
        this.gameObject.GetComponent<SpriteRenderer>().sprite= venusNormal;
    }
}
